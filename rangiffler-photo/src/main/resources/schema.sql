...
--delete from countries where code is not null;
--
...
--insert into countries(code, name) values ('CI', 'Côted Ivoire');
...
--insert into countries(code, name) values ('GM', 'The Gambia');
...
--insert into countries(code, name) values ('LA', 'Lao PDR');
--insert into countries(code, name) values ('MM', 'Myanmar');
--insert into countries(code, name) values ('VN', 'Vietnam');
--insert into countries(code, name) values ('KP', 'Dem. Rep. Korea');
...
--insert into countries(code, name) values ('CYP', 'Northern Cyprus');
...
--insert into countries(code, name) values ('SOM', 'Somaliland');
